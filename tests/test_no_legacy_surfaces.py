...
RETIRED_SURFACES = {
    ...
    "ExtensionRuntime": "runtime topology belongs to the Extension artifact and administrator policy",
    "extensionruntimes": "the ExtensionRuntime CRD is removed from the clean API",
...
ALLOWED = {
    ...
    ("ExtensionRuntime", "tests/test_no_legacy_surfaces.py"): "this guard declares the markers",
    ("extensionruntimes", "tests/test_no_legacy_surfaces.py"): "this guard declares the markers",
