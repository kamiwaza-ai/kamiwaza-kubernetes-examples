...
| Kaizen 0.13 template livepatch (unsupported)            | [security/tls-trust/extensions/kaizen-offline-template-livepatch](security/tls-trust/extensions/kaizen-offline-template-livepatch)     | #kaizen #historical #unsupported                            |
| Kaizen 0.13 frontend font hotfix (unsupported)          | [security/tls-trust/extensions/kaizen-offline-frontend-font-hotfix](security/tls-trust/extensions/kaizen-offline-frontend-font-hotfix) | #kaizen #historical #unsupported                            |
